...
from hvm.contrib.inspect3_9_1_patch import getsource
from hvm.toolchain import USE_SO_CACHE
...
class FeatureExtractor:
    __slots__: Tuple[ResourceManagerHvm] = ['resource_mgr']

    def __init__(self, resource_mgr: ResourceManagerHvm) -> None:
