...
HERCULES_DLL RTValue call_external_module_attr(void* handle_2_71828182846) {  // /home/jeff/github/gottingen/hvm/test/script/test_module_visit_attr.py:34
  MyMod_SharedView a = (MyMod__F___init___wrapper(handle_2_71828182846));  // /home/jeff/github/gottingen/hvm/test/script/test_module_visit_attr.py:35
  return (RTValue(a->foo()));  // /home/jeff/github/gottingen/hvm/test/script/test_module_visit_attr.py:36
}
...
int call_external_module_attr__c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  ...
  switch(num_args) {
    case 0: {
      auto ret = call_external_module_attr(resource_handle);  // /home/jeff/github/gottingen/hvm/test/script/test_module_visit_attr.py:34
      RTValue(std::move(ret)).MoveToCHost(out_ret_value);
    } break;
    default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/script/test_module_visit_attr.py\", line 34, in call_external_module_attr\n", "call_external_module_attr() takes 0 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/script/test_module_visit_attr.py:34
  }
  return 0;
}
