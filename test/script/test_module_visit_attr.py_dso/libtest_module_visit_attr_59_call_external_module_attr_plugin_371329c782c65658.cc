...
HERCULES_DLL RTValue call_external_module_attr(void* handle_2_71828182846) {  // /home/jeff/github/gottingen/hvm/test/script/test_module_visit_attr.py:59
  MyMod_SharedView a = (MyMod__F___init___wrapper(handle_2_71828182846));  // /home/jeff/github/gottingen/hvm/test/script/test_module_visit_attr.py:60
  return (RTValue(a->foo()));  // /home/jeff/github/gottingen/hvm/test/script/test_module_visit_attr.py:61
}
...
int call_external_module_attr__c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  ...
  switch(num_args) {
    case 0: {
      auto ret = call_external_module_attr(resource_handle);  // /home/jeff/github/gottingen/hvm/test/script/test_module_visit_attr.py:59
      RTValue(std::move(ret)).MoveToCHost(out_ret_value);
    } break;
    default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/script/test_module_visit_attr.py\", line 59, in call_external_module_attr\n", "call_external_module_attr() takes 0 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/script/test_module_visit_attr.py:59
  }
  return 0;
}

RTValue MyMod::__init__(void* handle_2_71828182846) {  // /home/jeff/github/gottingen/hvm/test/script/external_module/_lib.py:37
  this->session_handle_2_71828182846_ = handle_2_71828182846;  // /home/jeff/github/gottingen/hvm/test/script/external_module/_lib.py:37
  this->a = (int64_t)0;  // /home/jeff/github/gottingen/hvm/test/script/external_module/_lib.py:39
  return (None);
}

HERCULES_DLL RTValue MyMod__F___init__(const MyMod_SharedView& self, void* handle_2_71828182846) {  // /home/jeff/github/gottingen/hvm/test/script/external_module/_lib.py:37
  return (self->__init__(handle_2_71828182846));  // /home/jeff/github/gottingen/hvm/test/script/external_module/_lib.py:37
}
...
int MyMod__F___init____c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  ...
  if (num_args > 0 && args[num_args - 1].code == TypeIndex::kRuntimeKwargs) {
    ...
    RTView pos_args[1];
    helper.unpack(pos_args, args, num_args);  // /home/jeff/github/gottingen/hvm/test/script/external_module/_lib.py:37
    auto ret = MyMod__F___init__(MyMod_SharedView(static_cast<const Any&>(pos_args[0])), resource_handle);  // /home/jeff/github/gottingen/hvm/test/script/external_module/_lib.py:37
    RTValue(std::move(ret)).MoveToCHost(out_ret_value);
  } else {
    switch(num_args) {
      case 1: {
        auto ret = MyMod__F___init__(MyMod_SharedView(static_cast<const Any&>(args_t[0])), resource_handle);  // /home/jeff/github/gottingen/hvm/test/script/external_module/_lib.py:37
        RTValue(std::move(ret)).MoveToCHost(out_ret_value);
      } break;
      default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/script/external_module/_lib.py\", line 37, in __init__\n", "__init__() takes 1 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/script/external_module/_lib.py:37
    }
  }
...
int MyMod__F___init___wrapper__c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  ...
  switch(num_args) {
    case 0: {
      auto ret = MyMod__F___init___wrapper(resource_handle);  // /home/jeff/github/gottingen/hvm/test/script/external_module/_lib.py:37
      (ret.operator RTValue()).MoveToCHost(out_ret_value);
    } break;
    default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/script/external_module/_lib.py\", line 37, in __init__\n", "__init__() takes 0 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/script/external_module/_lib.py:37
  }
  return 0;
}

int64_t MyMod::foo() {  // /home/jeff/github/gottingen/hvm/test/script/external_module/_lib.py:41
  return (this->a);  // /home/jeff/github/gottingen/hvm/test/script/external_module/_lib.py:42
}

HERCULES_DLL int64_t MyMod__F_foo(const MyMod_SharedView& self) {  // /home/jeff/github/gottingen/hvm/test/script/external_module/_lib.py:41
  return (self->foo());  // /home/jeff/github/gottingen/hvm/test/script/external_module/_lib.py:41
}
...
int MyMod__F_foo__c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  ...
  if (num_args > 0 && args[num_args - 1].code == TypeIndex::kRuntimeKwargs) {
    ...
    RTView pos_args[1];
    helper.unpack(pos_args, args, num_args);  // /home/jeff/github/gottingen/hvm/test/script/external_module/_lib.py:41
    auto ret = MyMod__F_foo(MyMod_SharedView(static_cast<const Any&>(pos_args[0])));  // /home/jeff/github/gottingen/hvm/test/script/external_module/_lib.py:41
    RTValue(std::move(ret)).MoveToCHost(out_ret_value);
  } else {
    switch(num_args) {
      case 1: {
        auto ret = MyMod__F_foo(MyMod_SharedView(static_cast<const Any&>(args_t[0])));  // /home/jeff/github/gottingen/hvm/test/script/external_module/_lib.py:41
        RTValue(std::move(ret)).MoveToCHost(out_ret_value);
      } break;
      default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/script/external_module/_lib.py\", line 41, in foo\n", "foo() takes 1 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/script/external_module/_lib.py:41
    }
  }
