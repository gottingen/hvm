...
HERCULES_DLL Unicode my_interface(const MyBase_SharedView& b, void* handle_2_71828182846=((void*)(int64_t)0));
int my_interface__c_api(HerculesAny*, int, HerculesAny*, void*);
HERCULES_DLL Unicode call_func_child_as_super(void* handle_2_71828182846=((void*)(int64_t)0));
int call_func_child_as_super__c_api(HerculesAny*, int, HerculesAny*, void*);
...
HERCULES_DLL Unicode my_interface(const MyBase_SharedView& b, void* handle_2_71828182846) {  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:130
  return (b->foo());  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:131
}

int my_interface__c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  TArgs args_t(args, num_args);

  if (num_args > 0 && args[num_args - 1].code == TypeIndex::kRuntimeKwargs) {
    string_view arg_names[1] {"b"};
    KwargsUnpackHelper helper("my_interface", arg_names, 1, nullptr, 0);
    RTView pos_args[1];
    helper.unpack(pos_args, args, num_args);  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:130
    auto ret = my_interface(MyBase_SharedView(static_cast<const Any&>(pos_args[0])), resource_handle);  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:130
    RTValue(std::move(ret)).MoveToCHost(out_ret_value);
  } else {
    switch(num_args) {
      case 1: {
        auto ret = my_interface(MyBase_SharedView(static_cast<const Any&>(args_t[0])), resource_handle);  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:130
        RTValue(std::move(ret)).MoveToCHost(out_ret_value);
      } break;
      default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/script/test_inheritance.py\", line 130, in my_interface\n", "my_interface() takes 1 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:130
    }
  }
...
HERCULES_DLL Unicode call_func_child_as_super(void* handle_2_71828182846) {  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:133
  MyChild_SharedView c = (MyChild__F___init___wrapper(handle_2_71828182846));  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:134
  return (my_interface(CAST_TO_CLASS_VIEW_NOCHECK<MyChild_SharedView, MyBase_SharedView>(c), handle_2_71828182846));  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:135
}

int call_func_child_as_super__c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  TArgs args_t(args, num_args);

  switch(num_args) {
    case 0: {
      auto ret = call_func_child_as_super(resource_handle);  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:133
      RTValue(std::move(ret)).MoveToCHost(out_ret_value);
    } break;
    default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/script/test_inheritance.py\", line 133, in call_func_child_as_super\n", "call_func_child_as_super() takes 0 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:133
  }
  return 0;
}
...
HERCULES_DLL HerculesBackendPackedCFunc __hercules_func_array__[] = {
    (HerculesBackendPackedCFunc)MyBase__F___init___wrapper__c_api,
    (HerculesBackendPackedCFunc)MyChild__F___init___wrapper__c_api,
    (HerculesBackendPackedCFunc)call_func_child_as_super__c_api,
};
HERCULES_DLL HerculesFuncRegistry __hercules_func_registry__ = {
    "3\000MyBase__F___init___wrapper\000MyChild__F___init___wrapper\000call_func_child_as_super\000",    __hercules_func_array__,
};
...
HERCULES_DLL const char* __hercules_closures_names__ = "6\000MyBase__F___init___wrapper\000MyChild__F___init___wrapper\000my_interface\000call_func_child_as_super\000MyBase__F___init__\000MyChild__F___init__\000";
