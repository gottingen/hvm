...
HERCULES_DLL Unicode any_dispatch_call_super_func(void* handle_2_71828182846=((void*)(int64_t)0));
int any_dispatch_call_super_func__c_api(HerculesAny*, int, HerculesAny*, void*);
...
HERCULES_DLL Unicode any_dispatch_call_super_func(void* handle_2_71828182846) {  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:90
  MyChild_SharedView c = (MyChild__F___init___wrapper(handle_2_71828182846));  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:91
  RTValue a = ((c).operator RTValue());  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:92
  return (internal::TypeAsHelper<Unicode>::run((kernel_object___dispatch__(a, "foo", {})), __FILE__, __LINE__, "File \"/home/jeff/github/gottingen/hvm/test/script/test_inheritance.py\", line 93, in any_dispatch_call_super_func\n", "expect 'kernel_object___dispatch__(a, \"foo\", {})' is 'py::str' type"));  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:93
}

int any_dispatch_call_super_func__c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  TArgs args_t(args, num_args);

  switch(num_args) {
    case 0: {
      auto ret = any_dispatch_call_super_func(resource_handle);  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:90
      RTValue(std::move(ret)).MoveToCHost(out_ret_value);
    } break;
    default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/script/test_inheritance.py\", line 90, in any_dispatch_call_super_func\n", "any_dispatch_call_super_func() takes 0 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:90
  }
  return 0;
}
...
HERCULES_DLL HerculesBackendPackedCFunc __hercules_func_array__[] = {
    (HerculesBackendPackedCFunc)MyBase__F___init___wrapper__c_api,
    (HerculesBackendPackedCFunc)MyChild__F___init___wrapper__c_api,
    (HerculesBackendPackedCFunc)any_dispatch_call_super_func__c_api,
};
HERCULES_DLL HerculesFuncRegistry __hercules_func_registry__ = {
    "3\000MyBase__F___init___wrapper\000MyChild__F___init___wrapper\000any_dispatch_call_super_func\000",    __hercules_func_array__,
};
...
HERCULES_DLL const char* __hercules_closures_names__ = "5\000MyBase__F___init___wrapper\000MyChild__F___init___wrapper\000any_dispatch_call_super_func\000MyBase__F___init__\000MyChild__F___init__\000";
