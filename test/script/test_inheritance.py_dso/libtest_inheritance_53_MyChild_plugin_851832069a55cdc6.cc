...
// flags for convert check
uint32_t MyChild::tag_s_2_71828182846_ = -7409293278374639236;
...
RTValue MyBase::__init__(void* handle_2_71828182846) {  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:47
  this->session_handle_2_71828182846_ = handle_2_71828182846;  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:47
  this->val = GenericValueConverter<Unicode>{}(unicode_view(U"\u0042\u0061\u0073\u0065", 4));  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:48
  return (None);
}

HERCULES_DLL RTValue MyBase__F___init__(const MyBase_SharedView& self, void* handle_2_71828182846) {  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:47
  return (self->__init__(handle_2_71828182846));  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:47
}
...
int MyBase__F___init____c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  ...
  if (num_args > 0 && args[num_args - 1].code == TypeIndex::kRuntimeKwargs) {
    ...
    RTView pos_args[1];
    helper.unpack(pos_args, args, num_args);  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:47
    auto ret = MyBase__F___init__(MyBase_SharedView(static_cast<const Any&>(pos_args[0])), resource_handle);  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:47
    RTValue(std::move(ret)).MoveToCHost(out_ret_value);
  } else {
    switch(num_args) {
      case 1: {
        auto ret = MyBase__F___init__(MyBase_SharedView(static_cast<const Any&>(args_t[0])), resource_handle);  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:47
        RTValue(std::move(ret)).MoveToCHost(out_ret_value);
      } break;
      default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/script/test_inheritance.py\", line 47, in __init__\n", "__init__() takes 1 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:47
    }
  }
...
int MyBase__F___init___wrapper__c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  ...
  switch(num_args) {
    case 0: {
      auto ret = MyBase__F___init___wrapper(resource_handle);  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:47
      (ret.operator RTValue()).MoveToCHost(out_ret_value);
    } break;
    default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/script/test_inheritance.py\", line 47, in __init__\n", "__init__() takes 0 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:47
  }
  return 0;
}

Unicode MyBase::foo() {  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:50
  return (this->val);  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:51
}

HERCULES_DLL Unicode MyBase__F_foo(const MyBase_SharedView& self) {  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:50
  return (self->foo());  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:50
}
...
int MyBase__F_foo__c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  ...
  if (num_args > 0 && args[num_args - 1].code == TypeIndex::kRuntimeKwargs) {
    ...
    RTView pos_args[1];
    helper.unpack(pos_args, args, num_args);  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:50
    auto ret = MyBase__F_foo(MyBase_SharedView(static_cast<const Any&>(pos_args[0])));  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:50
    RTValue(std::move(ret)).MoveToCHost(out_ret_value);
  } else {
    switch(num_args) {
      case 1: {
        auto ret = MyBase__F_foo(MyBase_SharedView(static_cast<const Any&>(args_t[0])));  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:50
        RTValue(std::move(ret)).MoveToCHost(out_ret_value);
      } break;
      default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/script/test_inheritance.py\", line 50, in foo\n", "foo() takes 1 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:50
    }
  }
...
RTValue MyChild::__init__(void* handle_2_71828182846) {  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:54
  this->session_handle_2_71828182846_ = handle_2_71828182846;  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:54
  (void)this->MyBase::__init__();  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:55
  this->val = GenericValueConverter<Unicode>{}(unicode_view(U"\u0043\u0068\u0069\u006C\u0064", 5));  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:56
  return (None);
}

HERCULES_DLL RTValue MyChild__F___init__(const MyChild_SharedView& self, void* handle_2_71828182846) {  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:54
  return (self->__init__(handle_2_71828182846));  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:54
}
...
int MyChild__F___init____c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  ...
  if (num_args > 0 && args[num_args - 1].code == TypeIndex::kRuntimeKwargs) {
    ...
    KwargsUnpackHelper helper("__init__", arg_names, 1, nullptr, 0);
    RTView pos_args[1];
    helper.unpack(pos_args, args, num_args);  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:54
    auto ret = MyChild__F___init__(MyChild_SharedView(static_cast<const Any&>(pos_args[0])), resource_handle);  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:54
    RTValue(std::move(ret)).MoveToCHost(out_ret_value);
  } else {
    switch(num_args) {
      case 1: {
        auto ret = MyChild__F___init__(MyChild_SharedView(static_cast<const Any&>(args_t[0])), resource_handle);  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:54
        RTValue(std::move(ret)).MoveToCHost(out_ret_value);
      } break;
      default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/script/test_inheritance.py\", line 54, in __init__\n", "__init__() takes 1 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:54
    }
  }
...
int MyChild__F___init___wrapper__c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  ...
  switch(num_args) {
    case 0: {
      auto ret = MyChild__F___init___wrapper(resource_handle);  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:54
      (ret.operator RTValue()).MoveToCHost(out_ret_value);
    } break;
    default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/script/test_inheritance.py\", line 54, in __init__\n", "__init__() takes 0 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:54
  }
  return 0;
}

Unicode MyChild::__call__() {  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:58
  return (this->foo());  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:59
}

HERCULES_DLL Unicode MyChild__F___call__(const MyChild_SharedView& self) {  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:58
  return (self->__call__());  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:58
}
...
int MyChild__F___call____c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  ...
  if (num_args > 0 && args[num_args - 1].code == TypeIndex::kRuntimeKwargs) {
    ...
    RTView pos_args[1];
    helper.unpack(pos_args, args, num_args);  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:58
    auto ret = MyChild__F___call__(MyChild_SharedView(static_cast<const Any&>(pos_args[0])));  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:58
    RTValue(std::move(ret)).MoveToCHost(out_ret_value);
  } else {
    switch(num_args) {
      case 1: {
        auto ret = MyChild__F___call__(MyChild_SharedView(static_cast<const Any&>(args_t[0])));  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:58
        RTValue(std::move(ret)).MoveToCHost(out_ret_value);
      } break;
      default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/script/test_inheritance.py\", line 58, in __call__\n", "__call__() takes 1 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:58
    }
  }
...
HERCULES_DLL HerculesFuncRegistry __hercules_func_registry__ = {
    "3\000MyBase__F___init___wrapper\000MyChild__F___init___wrapper\000MyChild__F___call__\000",    __hercules_func_array__,
};
...
HERCULES_DLL const char* __hercules_closures_names__ = "4\000MyBase__F___init___wrapper\000MyChild__F___init___wrapper\000MyBase__F___init__\000MyChild__F___init__\000";
