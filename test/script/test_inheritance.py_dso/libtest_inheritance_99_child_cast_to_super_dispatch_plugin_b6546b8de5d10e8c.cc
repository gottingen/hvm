...
HERCULES_DLL Unicode child_cast_to_super_dispatch(void* handle_2_71828182846=((void*)(int64_t)0));
int child_cast_to_super_dispatch__c_api(HerculesAny*, int, HerculesAny*, void*);
...
HERCULES_DLL Unicode child_cast_to_super_dispatch(void* handle_2_71828182846) {  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:99
  MyChild_SharedView c = (MyChild__F___init___wrapper(handle_2_71828182846));  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:100
  MyBase_SharedView a = (CAST_TO_CLASS_VIEW_NOCHECK<MyChild_SharedView, MyBase_SharedView>(c));  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:101
  a = CAST_TO_CLASS_VIEW_NOCHECK<MyChild_SharedView, MyBase_SharedView>(c);  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:102
  return (a->foo());  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:103
}

int child_cast_to_super_dispatch__c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  TArgs args_t(args, num_args);

  switch(num_args) {
    case 0: {
      auto ret = child_cast_to_super_dispatch(resource_handle);  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:99
      RTValue(std::move(ret)).MoveToCHost(out_ret_value);
    } break;
    default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/script/test_inheritance.py\", line 99, in child_cast_to_super_dispatch\n", "child_cast_to_super_dispatch() takes 0 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:99
  }
  return 0;
}
...
HERCULES_DLL HerculesBackendPackedCFunc __hercules_func_array__[] = {
    (HerculesBackendPackedCFunc)MyBase__F___init___wrapper__c_api,
    (HerculesBackendPackedCFunc)MyChild__F___init___wrapper__c_api,
    (HerculesBackendPackedCFunc)child_cast_to_super_dispatch__c_api,
};
HERCULES_DLL HerculesFuncRegistry __hercules_func_registry__ = {
    "3\000MyBase__F___init___wrapper\000MyChild__F___init___wrapper\000child_cast_to_super_dispatch\000",    __hercules_func_array__,
};
...
HERCULES_DLL const char* __hercules_closures_names__ = "5\000MyBase__F___init___wrapper\000MyChild__F___init___wrapper\000child_cast_to_super_dispatch\000MyBase__F___init__\000MyChild__F___init__\000";
