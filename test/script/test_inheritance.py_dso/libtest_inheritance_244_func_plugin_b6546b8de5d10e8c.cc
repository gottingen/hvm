...
HERCULES_DLL Unicode func(void* handle_2_71828182846) {  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:244
  MySon_SharedView son = (MySon__F___init___wrapper(handle_2_71828182846));  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:245
  return (son->func());  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:246
}
...
int func__c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  ...
  switch(num_args) {
    case 0: {
      auto ret = func(resource_handle);  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:244
      RTValue(std::move(ret)).MoveToCHost(out_ret_value);
    } break;
    default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/script/test_inheritance.py\", line 244, in func\n", "func() takes 0 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/script/test_inheritance.py:244
  }
  return 0;
}
...
HERCULES_DLL HerculesFuncRegistry __hercules_func_registry__ = {
    "3\000MyBase__F___init___wrapper\000MySon__F___init___wrapper\000func\000",    __hercules_func_array__,
};
...
HERCULES_DLL const char* __hercules_closures_names__ = "5\000MyBase__F___init___wrapper\000MySon__F___init___wrapper\000func\000MyBase__F___init__\000MySon__F___init__\000";
