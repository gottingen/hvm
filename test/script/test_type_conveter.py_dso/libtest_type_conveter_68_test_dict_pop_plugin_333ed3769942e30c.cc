...
HERCULES_DLL Tuple test_dict_pop(void* handle_2_71828182846=((void*)(int64_t)0));
int test_dict_pop__c_api(HerculesAny*, int, HerculesAny*, void*);
...
HERCULES_DLL Tuple test_dict_pop(void* handle_2_71828182846) {  // /home/jeff/github/gottingen/hvm/test/script/test_type_conveter.py:68
  Dict l = (Kernel_Dict::make(std::initializer_list<Dict::value_type>{{unicode_view(U"\u0068\u0032", 2), MyDoc__F___init___wrapper(unicode_view(U"\u0068\u0061\u0068\u0061\u0032", 5), handle_2_71828182846)}, {unicode_view(U"\u0068", 1), MyDoc__F___init___wrapper(unicode_view(U"\u0068\u0061\u0068\u0061", 4), handle_2_71828182846)}}));  // /home/jeff/github/gottingen/hvm/test/script/test_type_conveter.py:69
  Unicode h = (MyDoc_SharedView(static_cast<const Any&>((l).pop({(unicode_view(U"\u0068", 1))})))->query);  // /home/jeff/github/gottingen/hvm/test/script/test_type_conveter.py:70
  RTValue h2 = (kernel_object___getattr__(((l).pop({(unicode_view(U"\u0068\u0032", 2)), ((int64_t)1)})), "query"));  // /home/jeff/github/gottingen/hvm/test/script/test_type_conveter.py:71
  return (Kernel_Tuple::make(std::initializer_list<Tuple::value_type>{(h), (h2)}));  // /home/jeff/github/gottingen/hvm/test/script/test_type_conveter.py:72
}

int test_dict_pop__c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  TArgs args_t(args, num_args);

  switch(num_args) {
    case 0: {
      auto ret = test_dict_pop(resource_handle);  // /home/jeff/github/gottingen/hvm/test/script/test_type_conveter.py:68
      RTValue(std::move(ret)).MoveToCHost(out_ret_value);
    } break;
    default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/script/test_type_conveter.py\", line 68, in test_dict_pop\n", "test_dict_pop() takes 0 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/script/test_type_conveter.py:68
  }
  return 0;
}
...
HERCULES_DLL HerculesBackendPackedCFunc __hercules_func_array__[] = {
    (HerculesBackendPackedCFunc)MyDoc__F___init___wrapper__c_api,
    (HerculesBackendPackedCFunc)test_dict_pop__c_api,
};
HERCULES_DLL HerculesFuncRegistry __hercules_func_registry__ = {
    "2\000MyDoc__F___init___wrapper\000test_dict_pop\000",    __hercules_func_array__,
};
...
HERCULES_DLL const char* __hercules_closures_names__ = "3\000MyDoc__F___init___wrapper\000test_dict_pop\000MyDoc__F___init__\000";
