...
get_move_var_lineno = hvm.get_global_func("ir.MoveOptimizer_GetMoveVarAndLineno")
...
class TestAutoMoveV2(unittest.TestCase):
    def test_func_match(self):
        ...
        func = hvm.ir_module(test_normal_move)["test_normal_move"]
        ...
        func = hvm.ir_module(test_if_branch_move)["test_if_branch_move"]
        info = get_move_var_lineno(func)
        ...
        func = hvm.ir_module(test_auto_for_move)["test_auto_for_move"]
        info = get_move_var_lineno(func)
        self.assertEqual(len(info), 1)
        ...
        func = hvm.ir_module(test_for_range_move)["test_for_range_move"]
        info = get_move_var_lineno(func)
        self.assertEqual(len(info), 2)
        self.assertEqual(info[0][0], b'a')
        ...
        func = hvm.ir_module(test_while_move)["test_while_move"]
        info = get_move_var_lineno(func)
        self.assertEqual(len(info), 1)
        self.assertEqual(info[0][0], b'd')
        ...
        func = hvm.ir_module(test_try_except)["test_try_except"]
        info = get_move_var_lineno(func)
        self.assertEqual(len(info), 2)
    ...
    def test_func_not_match(self):
        ...
        func = hvm.ir_module(test_use_twice1)["test_use_twice1"]
        info = get_move_var_lineno(func)
        ...
        func = hvm.ir_module(test_use_twice2)["test_use_twice2"]
        info = get_move_var_lineno(func)
        self.assertEqual(len(info), 0)
        ...
        func = hvm.ir_module(test_use_after_move0)["test_use_after_move0"]
        info = get_move_var_lineno(func)
        self.assertEqual(len(info), 0)
        ...
        func = hvm.ir_module(test_use_after_move1)["test_use_after_move1"]
        info = get_move_var_lineno(func)
        self.assertEqual(len(info), 0)
        ...
        func = hvm.ir_module(test_use_after_move2)["test_use_after_move2"]
        info = get_move_var_lineno(func)
        self.assertEqual(len(info), 0)
        ...
        func = hvm.ir_module(test_use_after_move3)["test_use_after_move3"]
        info = get_move_var_lineno(func)
        self.assertEqual(len(info), 0)
        ...
        func = hvm.ir_module(test_use_after_move4)["test_use_after_move4"]
        info = get_move_var_lineno(func)
        self.assertEqual(len(info), 0)
