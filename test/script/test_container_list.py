...
class TestContainerList(unittest.TestCase):
    def test_list_append(self):
        ...
        list_append_op = hvm.script(list_append)
    ...
    def test_generic_append(self):
        ...
        generic_append_op = hvm.script(generic_append)
    ...
    def test_list_repeat(self):
        ...
        list_repeat_op = hvm.script(list_repeat)
        list_repeat_cons_op = hvm.script(list_repeat_cons)
        ...
        list_repeat_object_type_times_op = hvm.script(list_repeat_object_type_times)
        list_repeat_object_type_times_cons_op = hvm.script(list_repeat_object_type_times_cons)
    ...
    def test_generic_repeat(self):
        ...
        generic_repeat_op = hvm.script(generic_repeat)
        generic_repeat_cons_op = hvm.script(generic_repeat_cons)
    ...
    def test_list_extend(self):
        ...
        list_extend_op = hvm.script(list_extend)
        list_extend_op_cons = hvm.script(list_extend_cons)
        ...
        list_extend2_op = hvm.script(list_extend2)
        list_extend2_cons_op = hvm.script(list_extend2_cons)
    ...
    def test_generic_extend(self):
        ...
        generic_extend_op = hvm.script(generic_extend)
    ...
    def test_general_in(self):
        ...
        general_in_op = hvm.script(general_in)
    ...
    def test_list_notin(self):
        ...
        list_notin_op = hvm.script(list_notin)
    ...
    def test_general_notin(self):
        ...
        general_notin_op = hvm.script(general_notin)
    ...
    def test_list_subscript(self):
        ...
        list_subscript_op = hvm.script(list_subscript)
    ...
    def test_general_subscript(self):
        ...
        general_subscript_op = hvm.script(general_subscript)
    ...
    #     list_reserve_op = hvm.script(list_reserve)
    #     b = list()
    ...
    #     general_reserve_op = hvm.script(general_reserve)
    #     b = list()
    ...
    def test_list_iterator(self):
        ...
        list_iterator_op = hvm.script(list_iterator)
        data = list([1, 3, 5])
    ...
    def test_generic_iterator(self):
        ...
        generic_iterator_op = hvm.script(generic_iterator)
        data = list([1, 3, 5])
    ...
    def test_add(self):
        ...
        list_add_op = hvm.script(list_add)
        a = list([1, 2, 3])
        b = list([4, 5, 6])
        c = list_add(a, b)
    ...
    def test_iadd(self):
        ...
        list_iadd_op = hvm.script(list_iadd)
        a = list([1, 2, 3])
        b = list([4, 5, 6])
        c = list([7, 8, 9])
        d = list_iadd(a, b)
    ...
    def test_list_remove(self):
        ...
        list_remove_op = hvm.script(list_remove)
        l = list([1, 2, 3, 1])
    ...
    def test_general_remove(self):
        ...
        general_remove_op = hvm.script(general_remove)
        l = list([1, 2, 3, 1])
    ...
    def test_list_insert(self):
        ...
        list_insert_op = hvm.script(list_insert)
        l = list([1, 2, 3, 4])
    ...
    def test_general_insert(self):
        ...
        general_insert_op = hvm.script(general_insert)
        l = list([1, 2, 3, 4])
    ...
    def test_general_index(self):
        ...
        list_index_int_op = hvm.script(list_index_int)
        list_index_with_start_op = hvm.script(list_index_with_start)
        list_index_with_start_end_op = hvm.script(list_index_with_start_end)
    ...
    def test_list_index(self):
        ...
        list_index_with_start_op = hvm.script(list_index_with_start)
        list_index_with_start_end_op = hvm.script(list_index_with_start_end)
        list_index_with_start_end_op2 = hvm.script(list_index_with_start_end2)
    ...
    def test_list_pop(self):
        ...
        list_pop_op = hvm.script(list_pop)
        l = list([1, 2, 3, 4, 5])
        a, l = list_pop_op(l, -1)
    ...
    def test_general_pop(self):
        ...
        general_pop_op = hvm.script(general_pop)
        l = list([1, 2, 3, 4, 5])
    ...
    def test_list_slice(self):
        ...
        hvm_list = list(python_list)
        python_ret = python_list[:9]
        hvm_ret = hvm_list[:9]
        hvm_script_slice = hvm.script(list_slice)
        hvm_script_ret = hvm_script_slice(python_list)

        self.assertEqual(python_list, python_ret)
        self.assertEqual(python_list, hvm_ret)
        self.assertEqual(python_list, hvm_script_ret)
    ...
    def test_list_clear(self):
        ...
        hvm_script_clear = hvm.script(list_clear)
        l2 = list([1, 2, 3])
        l2 = hvm_script_clear(l2)
    ...
    def test_list_basic_sort(self):
        ...
        tx_list_basic_sort = hvm.script(list_basic_sort)
        tx_any_basic_sort = hvm.script(any_basic_sort)
    ...
    def test_list_reverse_sort(self):
        ...
        tx_list_reverse_sort = hvm.script(list_reverse_sort)
        tx_any_reverse_sort = hvm.script(any_reverse_sort)
    ...
    def test_list_key_sort(self):
        ...
        tx_list_key_sort = hvm.script(list_key_sort)
        tx_any_key_sort = hvm.script(any_key_sort)
