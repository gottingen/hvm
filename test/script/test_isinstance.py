...
class TestIsinstance(unittest.TestCase):
    ...
    def test_is_float(self):
        ...
        tx_is_float = hvm.script(is_float)
    ...
    def test_explicit_is_prim(self):
        ...
        tx_ret = hvm.script(explicit_is_prim)()
        self.assertEqual(py_ret, tx_ret)
    ...
    def test_is_bytes(self):
        ...
        tx_is_bytes = hvm.script(is_bytes)
    ...
    def test_is_tuple(self):
        ...
        tx_is_tuple = hvm.script(is_tuple)
    ...
    def test_is_multi_type(self):
        ...
        tx_is_multi_type = hvm.script(is_multi_type)
