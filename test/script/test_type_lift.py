...
class TestTypeLift(unittest.TestCase):
    ...
    def test_assign_float_to_int(self):
        ...
        hvm.script(assign_float_to_int)
        ...
        with self.assertRaises(Exception):
            hvm.script(assign_attr_float_to_int)
        ...
        with self.assertRaises(Exception):
            hvm.script(assign_list_getitem_float_to_int)
        ...
        with self.assertRaises(Exception):
            hvm.script(assign_dict_getitem_float_to_int)
        ...
        with self.assertRaises(Exception):
            hvm.script(set_add_float_to_int)
