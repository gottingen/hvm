...
class TestTryExcept(unittest.TestCase):
    ...
    def test_try_no_throw(self):
        ...
        py_ret = try_no_throw()
        print(py_ret)
        tx_ret = hvm.script(try_no_throw)()
        print(tx_ret)
    ...
    def test_try_and_throw(self):
        ...
        print(py_ret)
        tx_ret = hvm.script(try_and_throw)()
        print(tx_ret)
        self.assertEqual(py_ret, tx_ret)
    ...
    def test_try_reporter(self):
        ...
        with self.assertRaises(BaseException):
            hvm.script(try_except_specific1)()
        ...
        with self.assertRaises(BaseException):
            hvm.script(try_except_specific2)()
        ...
        with self.assertRaises(BaseException):
            hvm.script(try_except_finally)()

    def test_throw_exception(self):
        def throw_exception() -> None:
            raise Exception("error")

        tx_func = hvm.script(throw_exception)
    ...
    def test_not_supported_throw_exception(self):
        ...
        with self.assertRaises(BaseException):
            hvm.script(not_supported_throw_exception)
