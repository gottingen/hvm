...
class TestFTList(unittest.TestCase):
    ...
    def test_print_ft_list(self):
        ...
        hvm.script(test_print_ft_list_impl)()
    ...
    def test_normal_ft_list(self):
        ...
        hvm.script(test_ft_list_of_int)
        hvm.script(test_ft_list_of_float)
        hvm.script(test_ft_list_of_bool)
        hvm.script(test_ft_list_of_str)
        hvm.script(test_ft_list_of_bytes)
        hvm.script(test_ft_list_of_list)
        hvm.script(test_ft_list_of_set)
        hvm.script(test_ft_list_of_dict)
        hvm.script(test_ft_list_of_tuple)
    ...
    def test_nested_ft_list(self):
        ...
        hvm.script(test_return_ft_list)
        hvm.script(test_arg_ft_list)
    ...
    def test_ft_list_basic_sort(self):
        ...
        tx_ft_list_basic_sort = hvm.script(ft_list_basic_sort)
    ...
    def test_ft_list_reverse_sort(self):
        ...
        tx_ft_list_reverse_sort = hvm.script(ft_list_reverse_sort)
    ...
    def test_ft_list_key_sort(self):
        ...
        tx_ft_list_key_sort = hvm.script(ft_list_key_sort)
