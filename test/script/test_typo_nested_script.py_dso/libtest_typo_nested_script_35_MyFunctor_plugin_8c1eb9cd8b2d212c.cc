...
HERCULES_DLL RTValue MyFunctor__F___call__(const MyFunctor_SharedView& self);
...
// flags for convert check
uint32_t MyFunctor::tag_s_2_71828182846_ = 1461094490763394455;
uint32_t MyFunctor::var_num_s_2_71828182846_ = 0;
...
RTValue MyFunctor::__init__(void* handle_2_71828182846) {  // /home/jeff/github/gottingen/hvm/test/script/test_typo_nested_script.py:36
  this->session_handle_2_71828182846_ = handle_2_71828182846;  // /home/jeff/github/gottingen/hvm/test/script/test_typo_nested_script.py:36
  return (None);
}

HERCULES_DLL RTValue MyFunctor__F___init__(const MyFunctor_SharedView& self, void* handle_2_71828182846) {  // /home/jeff/github/gottingen/hvm/test/script/test_typo_nested_script.py:36
  return (self->__init__(handle_2_71828182846));  // /home/jeff/github/gottingen/hvm/test/script/test_typo_nested_script.py:36
}
...
int MyFunctor__F___init____c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  ...
  if (num_args > 0 && args[num_args - 1].code == TypeIndex::kRuntimeKwargs) {
    ...
    RTView pos_args[1];
    helper.unpack(pos_args, args, num_args);  // /home/jeff/github/gottingen/hvm/test/script/test_typo_nested_script.py:36
    auto ret = MyFunctor__F___init__(MyFunctor_SharedView(static_cast<const Any&>(pos_args[0])), resource_handle);  // /home/jeff/github/gottingen/hvm/test/script/test_typo_nested_script.py:36
    RTValue(std::move(ret)).MoveToCHost(out_ret_value);
  } else {
    switch(num_args) {
      case 1: {
        auto ret = MyFunctor__F___init__(MyFunctor_SharedView(static_cast<const Any&>(args_t[0])), resource_handle);  // /home/jeff/github/gottingen/hvm/test/script/test_typo_nested_script.py:36
        RTValue(std::move(ret)).MoveToCHost(out_ret_value);
      } break;
      default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/script/test_typo_nested_script.py\", line 36, in __init__\n", "__init__() takes 1 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/script/test_typo_nested_script.py:36
    }
  }
...
int MyFunctor__F___init___wrapper__c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  ...
  switch(num_args) {
    case 0: {
      auto ret = MyFunctor__F___init___wrapper(resource_handle);  // /home/jeff/github/gottingen/hvm/test/script/test_typo_nested_script.py:36
      (ret.operator RTValue()).MoveToCHost(out_ret_value);
    } break;
    default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/script/test_typo_nested_script.py\", line 36, in __init__\n", "__init__() takes 0 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/script/test_typo_nested_script.py:36
  }
  return 0;
}

RTValue MyFunctor::__call__() {  // /home/jeff/github/gottingen/hvm/test/script/test_typo_nested_script.py:39
  return (None);  // /home/jeff/github/gottingen/hvm/test/script/test_typo_nested_script.py:40
}

HERCULES_DLL RTValue MyFunctor__F___call__(const MyFunctor_SharedView& self) {  // /home/jeff/github/gottingen/hvm/test/script/test_typo_nested_script.py:39
  return (self->__call__());  // /home/jeff/github/gottingen/hvm/test/script/test_typo_nested_script.py:39
}
...
int MyFunctor__F___call____c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  ...
  if (num_args > 0 && args[num_args - 1].code == TypeIndex::kRuntimeKwargs) {
    ...
    RTView pos_args[1];
    helper.unpack(pos_args, args, num_args);  // /home/jeff/github/gottingen/hvm/test/script/test_typo_nested_script.py:39
    auto ret = MyFunctor__F___call__(MyFunctor_SharedView(static_cast<const Any&>(pos_args[0])));  // /home/jeff/github/gottingen/hvm/test/script/test_typo_nested_script.py:39
    RTValue(std::move(ret)).MoveToCHost(out_ret_value);
  } else {
    switch(num_args) {
      case 1: {
        auto ret = MyFunctor__F___call__(MyFunctor_SharedView(static_cast<const Any&>(args_t[0])));  // /home/jeff/github/gottingen/hvm/test/script/test_typo_nested_script.py:39
        RTValue(std::move(ret)).MoveToCHost(out_ret_value);
      } break;
      default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/script/test_typo_nested_script.py\", line 39, in __call__\n", "__call__() takes 1 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/script/test_typo_nested_script.py:39
    }
  }
...
HERCULES_DLL HerculesFuncRegistry __hercules_func_registry__MyFunctor = {
    "3\000MyFunctor__F___init___wrapper\000MyFunctor__F___init__\000MyFunctor__F___call__\000",    __hercules_func_array__MyFunctor,
};
...
HERCULES_DLL HerculesFuncRegistry __hercules_func_registry__ = {
    "2\000MyFunctor__F___init___wrapper\000MyFunctor__F___call__\000",    __hercules_func_array__,
};
