...
class TestInheritance(unittest.TestCase):
    ...
    def test_any_dispatch(self):
        ...
        tx_ret = hvm.script(any_dispatch_call_child_func)()
        self.assertEqual(py_ret, tx_ret)
        ...
        tx_ret = hvm.script(any_dispatch_call_super_func)()
        self.assertEqual(py_ret, tx_ret)
        ...
        tx_ret = hvm.script(child_cast_to_super_dispatch)()
        self.assertEqual(py_ret, tx_ret)
        ...
        fn = hvm.script(super_cast_to_child_dispatch)
        ...
        tx_ret = hvm.script(super_cast_to_child_dispatch2)()
        self.assertEqual(py_ret, tx_ret)
        ...
        tx_ret = hvm.script(call_func_child_as_super)()
        self.assertEqual(py_ret, tx_ret)
    ...
    def test_polymorphism(self):
        ...
        tx_ret = hvm.script(explicit_super)()
        self.assertEqual(py_ret, tx_ret)
