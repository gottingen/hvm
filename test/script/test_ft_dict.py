...
class TestFTSet(unittest.TestCase):
    ...
    def test_normal_ft_dict(self):
        ...
        hvm.script(test_ft_dict_of_int_int)
        hvm.script(test_ft_dict_of_bool_bool)
        hvm.script(test_ft_dict_of_str_str)
        hvm.script(test_ft_dict_of_bytes_bytes)
    ...
    def test_nested_ft_dict(self):
        ...
        hvm.script(test_return_ft_dict)
        hvm.script(test_arg_ft_dict)
