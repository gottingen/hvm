...
HERCULES_DLL int64_t wrapper(void* handle_2_71828182846) {  // /home/jeff/github/gottingen/hvm/test/script/test_interface.py:49
  MyData_SharedView d = (MyData__F___init___wrapper(handle_2_71828182846));  // /home/jeff/github/gottingen/hvm/test/script/test_interface.py:50
  return (d->__call__(unicode_view(U"\u0061\u0062\u0063", 3)));  // /home/jeff/github/gottingen/hvm/test/script/test_interface.py:51
}
...
int wrapper__c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  ...
  switch(num_args) {
    case 0: {
      auto ret = wrapper(resource_handle);  // /home/jeff/github/gottingen/hvm/test/script/test_interface.py:49
      RTValue(std::move(ret)).MoveToCHost(out_ret_value);
    } break;
    default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/script/test_interface.py\", line 49, in wrapper\n", "wrapper() takes 0 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/script/test_interface.py:49
  }
  return 0;
}
...
HERCULES_DLL HerculesFuncRegistry __hercules_func_registry__ = {
    "3\000MyInterface__F___init___wrapper\000MyData__F___init___wrapper\000wrapper\000",    __hercules_func_array__,
};
...
HERCULES_DLL const char* __hercules_closures_names__ = "5\000MyInterface__F___init___wrapper\000MyData__F___init___wrapper\000wrapper\000MyInterface__F___init__\000MyData__F___init__\000";
