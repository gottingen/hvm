...
class TestContainerComprehension(unittest.TestCase):
    ...
    def test_list_comp(self):
        ...
        print(py_ret)
        tx_ret = hvm.script(test_list_comp_nested)(input_b)
        print(tx_ret)
    ...
    def test_set_comp(self):
        ...
        print(py_ret)
        tx_ret = hvm.script(test_set_comp_nested)(input_b)
        print(tx_ret)
        self.assertEqual(py_ret, tx_ret)
    ...
    def test_dict_comp(self):
        ...
        print(py_ret)
        tx_ret = hvm.script(test_dict_comp_nested)(input_b)
        print(tx_ret)
        self.assertEqual(py_ret, tx_ret)
