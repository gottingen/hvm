...
class TestContainerTuple(unittest.TestCase):
    def test_len_tuple2(self):
        ...
        scripted_len_tuple = hvm.script(len_tuple)
    ...
    def test_tuple_repeat(self):
        ...
        tuple_repeat_op = hvm.script(tuple_repeat)
        ...
        tuple_repeat_object_type_times_op = hvm.script(tuple_repeat_object_type_times)
    ...
    def test_tuple_in(self):
        ...
        tuple_in_op = hvm.script(tuple_in)
    ...
    def test_tuple_notin(self):
        ...
        tuple_notin_op = hvm.script(tuple_notin)
    ...
    def test_tuple_subscript(self):
        ...
        tuple_subscript_op = hvm.script(tuple_subscript)
    ...
    def test_tuple_iterator(self):
        ...
        tuple_iterator_op = hvm.script(tuple_iterator)
        data = (1, 3, 5,)
    ...
    def test_tuple_slice(self):
        ...
        hvm_tuple = hvm.Tuple(*python_tuple)
        python_ret = python_tuple[:9]
        hvm_ret = hvm_tuple[:9]
        hvm_script_slice = hvm.script(tuple_slice)
        hvm_script_ret = hvm_script_slice(python_tuple)

        self.assertEqual(python_tuple, python_ret)
        self.assertEqual(python_tuple, hvm_ret)
        self.assertEqual(python_tuple, hvm_script_ret)
    ...
    def test_tuple_hash_equal(self):
        ...
        tx_ret = hvm.script(tuple_explicit_equal)()
        ...
        tx_ret = hvm.script(tuple_any_equal)()
        self.assertEqual(py_ret, tx_ret)
