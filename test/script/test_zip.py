...
class TestZip(unittest.TestCase):
    ...
    def test_zip_list(self):
        ...
        print(py_ret)
        tx_ret = hvm.script(zip_two_list)(input_a, input_b)
        print(tx_ret)
    ...
    def test_zip_any(self):
        ...
        print(py_ret)
        tx_ret = hvm.script(zip_two_any)(input_a, input_b)
        print(tx_ret)
        self.assertEqual(py_ret, tx_ret)
    ...
    def test_zip_str(self):
        ...
        print(py_ret)
        tx_ret = hvm.script(zip_two_str)(input_a, input_b)
        print(tx_ret)
        self.assertEqual(py_ret, tx_ret)
    ...
    def test_zip_return_one(self):
        ...
        print(py_ret)
        tx_ret = hvm.script(zip_two_list_return_tup)(input_a, input_b)
        print(tx_ret)
        self.assertEqual(py_ret, tx_ret)
        ...
        print(py_ret)
        tx_ret = hvm.script(zip_two_str_return_tup)(input_a, input_b)
        print(tx_ret)
