...
class TestFTSet(unittest.TestCase):
    ...
    def test_normal_ft_set(self):
        ...
        hvm.script(test_ft_set_of_int)
        hvm.script(test_ft_set_of_float)
        hvm.script(test_ft_set_of_bool)
        hvm.script(test_ft_set_of_str)
        hvm.script(test_ft_set_of_bytes)
    ...
    def test_nested_ft_set(self):
        ...
        hvm.script(test_return_ft_set)
        hvm.script(test_arg_ft_set)
