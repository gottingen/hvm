...
checker = hvm.get_global_func("ir.AssignOptimizer_Match")
...
class TestAutoMove(unittest.TestCase):
    def test_func_match(self):
        ...
        func = hvm.ir_module(test_use_after_move)["test_use_after_move"]
        self.assertTrue(checker(func))

        res = hvm.script(test_use_after_move)(["hello world"], " ", 0)
    ...
    def test_filter(self):
        ...
        func = hvm.ir_module(test_func_with_if)["test_func_with_if"]
        ...
        func = hvm.ir_module(test_func_with_for)["test_func_with_for"]
        self.assertFalse(checker(func))
        ...
        func = hvm.ir_module(test_func_with_while)["test_func_with_while"]
        self.assertFalse(checker(func))
        ...
        func = hvm.ir_module(test_func_with_auto_for)["test_func_with_auto_for"]
        self.assertFalse(checker(func))
