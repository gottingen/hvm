...
class TestHvmArith(unittest.TestCase):
    ...
    def test_advance_logic(self):
        ...
        self.assertEqual(test_int_and(), hvm.script(test_int_and)())
        self.assertEqual(test_str_and1(), hvm.script(test_str_and1)())
        self.assertEqual(test_str_and2(), hvm.script(test_str_and2)())
        self.assertEqual(test_bytes_and1(), hvm.script(test_bytes_and1)())
        self.assertEqual(test_bytes_and2(), hvm.script(test_bytes_and2)())
        self.assertEqual(test_any_and(), hvm.script(test_any_and)())
        ...
        self.assertEqual(test_int_or(), hvm.script(test_int_or)())
        self.assertEqual(test_str_or1(), hvm.script(test_str_or1)())
        self.assertEqual(test_str_or2(), hvm.script(test_str_or2)())
        self.assertEqual(test_bytes_or1(), hvm.script(test_bytes_or1)())
        self.assertEqual(test_bytes_or2(), hvm.script(test_bytes_or2)())
        self.assertEqual(test_any_or(), hvm.script(test_any_or)())
        ...
        self.assertEqual(test_and_or(), hvm.script(test_and_or)())
    ...
    def test_container_comp(self):
        ...
        generic_comp_op = hvm.script(generic_comp)
        list_comp_op = hvm.script(list_comp)
        ftlist_comp_op = hvm.script(ftlist_comp)
        tuple_comp_op = hvm.script(tuple_comp)
        ...
        #     return a, b, c, d
        # self.assertEqual(wrapper(), hvm.script(wrapper)())
