...
HERCULES_DLL RTValue test_ndarray_unpack_at_axis0(void* handle_2_71828182846=((void*)(int64_t)0));
int test_ndarray_unpack_at_axis0__c_api(HerculesAny*, int, HerculesAny*, void*);
...
HERCULES_DLL RTValue test_ndarray_unpack_at_axis0(void* handle_2_71828182846) {  // /home/jeff/github/gottingen/hvm/test/script/test_ndarray.py:974
  MyNDArrayGenerator_SharedView g = (MyNDArrayGenerator__F___init___wrapper(handle_2_71828182846));  // /home/jeff/github/gottingen/hvm/test/script/test_ndarray.py:975
  List li = (Kernel_List::make(std::initializer_list<List::value_type>{}));  // /home/jeff/github/gottingen/hvm/test/script/test_ndarray.py:976
  NDArray __reserved_tmp_iter_expr_74024035 = (g->make_ndarray());  // /home/jeff/github/gottingen/hvm/test/script/test_ndarray.py:977
  if ((((int64_t)(__reserved_tmp_iter_expr_74024035).GetDim()) > (int64_t)1)) {  // /home/jeff/github/gottingen/hvm/test/script/test_ndarray.py:977
    for (int64_t __reserved_nd_pos_8126920711206779044_53636175_iter_ = (int64_t)0; __reserved_nd_pos_8126920711206779044_53636175_iter_ < (__reserved_tmp_iter_expr_74024035).size(); __reserved_nd_pos_8126920711206779044_53636175_iter_ += (int64_t)1) {  // /home/jeff/github/gottingen/hvm/test/script/test_ndarray.py:977
      int64_t __reserved_nd_pos_8126920711206779044_53636175 = __reserved_nd_pos_8126920711206779044_53636175_iter_;  // /home/jeff/github/gottingen/hvm/test/script/test_ndarray.py:977
      NDArray s = (internal::TypeAsHelper<NDArray>::run(((__reserved_tmp_iter_expr_74024035).get_item((__reserved_nd_pos_8126920711206779044_53636175))), __FILE__, __LINE__, "File \"/home/jeff/github/gottingen/hvm/test/script/test_ndarray.py\", line 977, in test_ndarray_unpack_at_axis0\n", "expect '(__reserved_tmp_iter_expr_74024035).get_item((__reserved_nd_pos_8126920711206779044_53636175))' is 'NDArray' type"));  // /home/jeff/github/gottingen/hvm/test/script/test_ndarray.py:977
      (void)(li).append((RTValue(s)));  // /home/jeff/github/gottingen/hvm/test/script/test_ndarray.py:978
    }
  } else {
    for (int64_t __reserved_any_pos_8126920711206779044_49819269_iter_ = (int64_t)0; __reserved_any_pos_8126920711206779044_49819269_iter_ < (__reserved_tmp_iter_expr_74024035).size(); __reserved_any_pos_8126920711206779044_49819269_iter_ += (int64_t)1) {  // /home/jeff/github/gottingen/hvm/test/script/test_ndarray.py:977
      int64_t __reserved_any_pos_8126920711206779044_49819269 = __reserved_any_pos_8126920711206779044_49819269_iter_;  // /home/jeff/github/gottingen/hvm/test/script/test_ndarray.py:977
      RTValue s = ((__reserved_tmp_iter_expr_74024035).get_item((__reserved_any_pos_8126920711206779044_49819269)));  // /home/jeff/github/gottingen/hvm/test/script/test_ndarray.py:977
      (void)(li).append((s));  // /home/jeff/github/gottingen/hvm/test/script/test_ndarray.py:978
    }
  }
  return (RTValue(li));  // /home/jeff/github/gottingen/hvm/test/script/test_ndarray.py:979
}

int test_ndarray_unpack_at_axis0__c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  TArgs args_t(args, num_args);

  switch(num_args) {
    case 0: {
      auto ret = test_ndarray_unpack_at_axis0(resource_handle);  // /home/jeff/github/gottingen/hvm/test/script/test_ndarray.py:974
      RTValue(std::move(ret)).MoveToCHost(out_ret_value);
    } break;
    default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/script/test_ndarray.py\", line 974, in test_ndarray_unpack_at_axis0\n", "test_ndarray_unpack_at_axis0() takes 0 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/script/test_ndarray.py:974
  }
  return 0;
}
...
HERCULES_DLL HerculesBackendPackedCFunc __hercules_func_array__[] = {
    (HerculesBackendPackedCFunc)MyNDArrayGenerator__F___init___wrapper__c_api,
    (HerculesBackendPackedCFunc)test_ndarray_unpack_at_axis0__c_api,
};
HERCULES_DLL HerculesFuncRegistry __hercules_func_registry__ = {
    "2\000MyNDArrayGenerator__F___init___wrapper\000test_ndarray_unpack_at_axis0\000",    __hercules_func_array__,
};
...
HERCULES_DLL const char* __hercules_closures_names__ = "3\000MyNDArrayGenerator__F___init___wrapper\000test_ndarray_unpack_at_axis0\000MyNDArrayGenerator__F___init__\000";
