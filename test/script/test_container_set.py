...
class TestContainerSet(unittest.TestCase):
    ...
    def test_builtin_set(self):
        ...
        test_data = {"init"}
        self.assertEqual(set_add(test_data, 10), hvm.Set(["init", 10]))
        self.assertEqual(generic_add(test_data, 10), hvm.Set(["init", 10]))
    ...
    def test_set_clear(self):
        ...
        self.assertEqual(generic_clear(hvm.Set([1, 2, 3])), 0)

    def test_set_reserve(self):

        @hvm.script
        def set_reserve(x: hvm.Set, new_size: int) -> hvm.Set:
            x.reserve(new_size)
            return x
    ...
    def test_set_general_iter(self):
        ...
        l = [1, 2, 3, 4]
        s = set(l)
        op = hvm.script(set_general_iter)
    ...
    def test_set_difference(self):
        ...
        set_difference_op = hvm.script(set_difference)
        s = {1, 2, 3}
    ...
    def test_general_difference(self):
        ...
        general_difference_op = hvm.script(general_difference)
        s = {1, 2, 3}
    ...
    def test_set_discard(self):
        def set_discard(s: Set, a: Any) -> Set:
            s.discard(a)
            return s
        set_discard_op = hvm.script(set_discard)
        s = {1, 2, 3, 4, 5}
    ...
    def test_general_discard(self):
        def general_discard(s: Any, a: Any) -> Set:
            s.discard(a)
            return s
        general_discard_op = hvm.script(general_discard)
        s = {1, 2, 3, 4, 5}
    ...
    def test_set_difference_update(self):
        ...
        set_difference_update_op = hvm.script(set_difference_update)
    ...
    def test_general_difference_update(self):
        ...
        general_difference_update_op = hvm.script(general_difference_update)
    ...
    def test_set_update(self):
        ...
        set_update_op = hvm.script(set_update)
        ret = set_update()
    ...
    def test_generic_update(self):
        ...
        generic_set_update_op = hvm.script(generic_set_update)
    ...
    def test_set_union(self):
        ...
        set_union_op = hvm.script(set_union)
        a, b = set_union()
    ...
    def test_generic_union(self):
        ...
        generic_set_union_op = hvm.script(generic_set_union)
