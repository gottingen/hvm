...
from hvm import FTList, FTSet, FTDict
...
class TestControlFlow(unittest.TestCase):
    ...
    def test_range_step(self):
        ...
        tx_res = hvm.script(for_with_neg_step1)()
        ...
        tx_res = hvm.script(for_with_neg_step2)()
        self.assertEqual(py_res, tx_res)
        ...
        tx_res = hvm.script(for_with_neg_step3)(1)
        self.assertEqual(py_res, tx_res)
        py_res = for_with_neg_step3(-1)
        tx_res = hvm.script(for_with_neg_step3)(-1)
        self.assertEqual(py_res, tx_res)
        ...
        tx_res = hvm.script(for_with_pos_step)()
        self.assertEqual(py_res, tx_res)
    ...
    def test_step_parse(self):
        ...
        op_constructor = hvm.script(RangeStep)
