...
HERCULES_DLL int64_t test_call2(void* handle_2_71828182846) {  // /home/jeff/github/gottingen/hvm/test/script/test_keyword_args.py:209
  return (MyFoo__F___init___wrapper((int64_t)3, (int64_t)1, handle_2_71828182846)->foo((int64_t)3, (int64_t)1));  // /home/jeff/github/gottingen/hvm/test/script/test_keyword_args.py:210
}
...
int test_call2__c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  ...
  switch(num_args) {
    case 0: {
      auto ret = test_call2(resource_handle);  // /home/jeff/github/gottingen/hvm/test/script/test_keyword_args.py:209
      RTValue(std::move(ret)).MoveToCHost(out_ret_value);
    } break;
    default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/script/test_keyword_args.py\", line 209, in test_call2\n", "test_call2() takes 0 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/script/test_keyword_args.py:209
  }
  return 0;
}
