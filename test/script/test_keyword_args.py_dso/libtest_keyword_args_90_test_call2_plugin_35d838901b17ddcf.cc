...
HERCULES_DLL int64_t test_call2(void* handle_2_71828182846) {  // /home/jeff/github/gottingen/hvm/test/script/test_keyword_args.py:90
  RTValue f = (RTValue(MakeUserFunction(string_view("func", 4), (HerculesBackendPackedCFunc)func__c_api, handle_2_71828182846)));  // /home/jeff/github/gottingen/hvm/test/script/test_keyword_args.py:91
  return (internal::TypeAsHelper<int64_t>::run((kernel_object_call(f, {(::hercules::runtime::Kwargs({{"a", (int64_t)3}, {"b", (int64_t)1}}))})), __FILE__, __LINE__, "File \"/home/jeff/github/gottingen/hvm/test/script/test_keyword_args.py\", line 92, in test_call2\n", "expect 'kernel_object_call(f, {(::hercules::runtime::Kwargs({{\"a\", (int64_t)3}, {\"b\", (int64_t)1}}))})' is 'int64_t' type"));  // /home/jeff/github/gottingen/hvm/test/script/test_keyword_args.py:92
}
...
int test_call2__c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  ...
  switch(num_args) {
    case 0: {
      auto ret = test_call2(resource_handle);  // /home/jeff/github/gottingen/hvm/test/script/test_keyword_args.py:90
      RTValue(std::move(ret)).MoveToCHost(out_ret_value);
    } break;
    default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/script/test_keyword_args.py\", line 90, in test_call2\n", "test_call2() takes 0 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/script/test_keyword_args.py:90
  }
  return 0;
}
