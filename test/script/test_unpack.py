...
class TestBuiltinUnpack(unittest.TestCase):
    ...
    def test_unpack_in_for_ctx(self):
        ...
        tx_ret = hvm.script(test_unpack_list_in_for_ctx)(my_test_data)
        ...
        tx_ret = hvm.script(test_unpack_tuple_in_for_ctx)(my_test_data)
        self.assertEqual(py_ret, tx_ret)
        ...
        tx_ret = hvm.script(test_unpack_any_in_for_ctx)(my_test_data)
        self.assertEqual(py_ret, tx_ret)
