...
HERCULES_DLL int64_t my_explicit_access_var(void* handle_2_71828182846=((void*)(int64_t)0));
int my_explicit_access_var__c_api(HerculesAny*, int, HerculesAny*, void*);
...
HERCULES_DLL int64_t my_explicit_access_var(void* handle_2_71828182846) {  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:44
  ClassWithFullTypedVar_SharedView a = (ClassWithFullTypedVar__F___init___wrapper(handle_2_71828182846));  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:45
  int64_t s = ((int64_t)0);  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:46
  {
    FTList<int64_t> const& __reserved_eval_cons_i45344_0 = a->b;  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:47
    auto __reserved_iter_i7935_0 = __reserved_eval_cons_i45344_0.begin();  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:47
    auto __reserved_iter_end_i2112_0 = __reserved_eval_cons_i45344_0.end();  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:47
    while ((__reserved_iter_i7935_0 != __reserved_iter_end_i2112_0)) {  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:47
      int64_t i = *__reserved_iter_i7935_0;  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:47
      ++__reserved_iter_i7935_0;  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:47
      {
        s = (s + i);  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:48
      }
    }
  }
  return (s);  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:49
}

int my_explicit_access_var__c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  TArgs args_t(args, num_args);

  switch(num_args) {
    case 0: {
      auto ret = my_explicit_access_var(resource_handle);  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:44
      RTValue(std::move(ret)).MoveToCHost(out_ret_value);
    } break;
    default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py\", line 44, in my_explicit_access_var\n", "my_explicit_access_var() takes 0 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:44
  }
  return 0;
}
...
HERCULES_DLL HerculesBackendPackedCFunc __hercules_func_array__[] = {
    (HerculesBackendPackedCFunc)ClassWithFullTypedVar__F___init___wrapper__c_api,
    (HerculesBackendPackedCFunc)my_explicit_access_var__c_api,
};
HERCULES_DLL HerculesFuncRegistry __hercules_func_registry__ = {
    "2\000ClassWithFullTypedVar__F___init___wrapper\000my_explicit_access_var\000",    __hercules_func_array__,
};
...
HERCULES_DLL const char* __hercules_closures_names__ = "3\000ClassWithFullTypedVar__F___init___wrapper\000my_explicit_access_var\000ClassWithFullTypedVar__F___init__\000";
