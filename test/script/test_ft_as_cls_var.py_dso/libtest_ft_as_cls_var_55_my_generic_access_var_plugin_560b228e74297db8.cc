...
HERCULES_DLL int64_t my_generic_access_var(void* handle_2_71828182846=((void*)(int64_t)0));
int my_generic_access_var__c_api(HerculesAny*, int, HerculesAny*, void*);
...
HERCULES_DLL int64_t my_generic_access_var(void* handle_2_71828182846) {  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:55
  ClassWithFullTypedVar_SharedView a = (ClassWithFullTypedVar__F___init___wrapper(handle_2_71828182846));  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:56
  RTValue obj = ((a).operator RTValue());  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:57
  int64_t s = ((int64_t)0);  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:58
  {
    RTValue const& __reserved_eval_cons_i45344_0 = kernel_object___getattr__(obj, "b");  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:59
    RTValue __reserved_next_holder_i39341_0;  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:59
    auto __reserved_iter_i7935_0 = Kernel_Iterable::make(__reserved_eval_cons_i45344_0);  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:59
    auto __reserved_has_next_i63509_0 = __reserved_iter_i7935_0.HasNext();  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:59
    while (__reserved_has_next_i63509_0) {  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:59
      RTView i = __reserved_iter_i7935_0.NextView(&__reserved_has_next_i63509_0, &__reserved_next_holder_i39341_0);  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:59
      {
        s = internal::TypeAsHelper<int64_t>::run((ArithOps::add(s, i)), __FILE__, __LINE__, "File \"/home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py\", line 60, in my_generic_access_var\n", "expect 'ArithOps::add(s, i)' is 'int64_t' type");  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:60
      }
    }
  }
  return (s);  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:61
}

int my_generic_access_var__c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  TArgs args_t(args, num_args);

  switch(num_args) {
    case 0: {
      auto ret = my_generic_access_var(resource_handle);  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:55
      RTValue(std::move(ret)).MoveToCHost(out_ret_value);
    } break;
    default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py\", line 55, in my_generic_access_var\n", "my_generic_access_var() takes 0 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:55
  }
  return 0;
}
...
HERCULES_DLL HerculesBackendPackedCFunc __hercules_func_array__[] = {
    (HerculesBackendPackedCFunc)ClassWithFullTypedVar__F___init___wrapper__c_api,
    (HerculesBackendPackedCFunc)my_generic_access_var__c_api,
};
HERCULES_DLL HerculesFuncRegistry __hercules_func_registry__ = {
    "2\000ClassWithFullTypedVar__F___init___wrapper\000my_generic_access_var\000",    __hercules_func_array__,
};
...
HERCULES_DLL const char* __hercules_closures_names__ = "3\000ClassWithFullTypedVar__F___init___wrapper\000my_generic_access_var\000ClassWithFullTypedVar__F___init__\000";
