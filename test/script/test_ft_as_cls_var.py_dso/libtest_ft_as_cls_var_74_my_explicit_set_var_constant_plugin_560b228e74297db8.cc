...
HERCULES_DLL RTValue my_explicit_set_var_constant(void* handle_2_71828182846=((void*)(int64_t)0));
int my_explicit_set_var_constant__c_api(HerculesAny*, int, HerculesAny*, void*);
...
HERCULES_DLL RTValue my_explicit_set_var_constant(void* handle_2_71828182846) {  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:74
  ClassWithFullTypedVar_SharedView a = (ClassWithFullTypedVar__F___init___wrapper(handle_2_71828182846));  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:75
  a->b = Kernel_FTList::make<int64_t>(std::initializer_list<FTList<int64_t>::value_type>{});  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:76
  return (None);
}

int my_explicit_set_var_constant__c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  TArgs args_t(args, num_args);

  switch(num_args) {
    case 0: {
      auto ret = my_explicit_set_var_constant(resource_handle);  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:74
      RTValue(std::move(ret)).MoveToCHost(out_ret_value);
    } break;
    default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py\", line 74, in my_explicit_set_var_constant\n", "my_explicit_set_var_constant() takes 0 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/script/test_ft_as_cls_var.py:74
  }
  return 0;
}
...
HERCULES_DLL HerculesBackendPackedCFunc __hercules_func_array__[] = {
    (HerculesBackendPackedCFunc)ClassWithFullTypedVar__F___init___wrapper__c_api,
    (HerculesBackendPackedCFunc)my_explicit_set_var_constant__c_api,
};
HERCULES_DLL HerculesFuncRegistry __hercules_func_registry__ = {
    "2\000ClassWithFullTypedVar__F___init___wrapper\000my_explicit_set_var_constant\000",    __hercules_func_array__,
};
...
HERCULES_DLL const char* __hercules_closures_names__ = "3\000ClassWithFullTypedVar__F___init___wrapper\000my_explicit_set_var_constant\000ClassWithFullTypedVar__F___init__\000";
