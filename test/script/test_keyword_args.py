...
class TestKeywordArgs(unittest.TestCase):
    ...
    def test_class_init_explicit_kwargs_with_defaults(self):
        ...
        tx_ret = hvm.script(test_call_init)()
        self.assertEqual(py_ret, tx_ret)
        ...
        tx_ret = hvm.script(test_call_methods)()
        self.assertEqual(py_ret, tx_ret)
