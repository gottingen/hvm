...
class TestIterator(unittest.TestCase):
    def test_str_iter(self):
        ...
        hvm.script(str_iter)("hello")
        hvm.script(byte_iter)(b"hello")
        hvm.script(generic_str_iter)("hello")
        hvm.script(generic_byte_iter)(b"hello")
    ...
    def test_tuple_iter(self):
        ...
        hvm.script(tuple_iter)(("hello", "hello"))
        hvm.script(generic_tuple_iter)(("hello", "hello"))
    ...
    def test_list_builtin_iter(self):
        ...
        hvm_iter_result = hvm.script(builtin_list_iter)(original_list)
        self.assertListEqual(python_iter_result, list(hvm_iter_result))
    ...
    def test_list_reversed_iter(self):
        ...
        hvm_reversed_result = hvm.script(builtin_list_reversed)(original_list)
        self.assertListEqual(python_reversed_result, list(hvm_reversed_result))
    ...
    def test_tuple_iter_exception(self):
        ...
        original_tuple = (1, 2)
        try:
            hvm_iter_result = hvm.script(builtin_tuple_iter)(original_tuple)
    ...
    def test_tuple_reversed_exception(self):
        ...
        original_tuple = (1, 2)
        try:
            hvm_reversed_result = hvm.script(builtin_tuple_reversed)(original_tuple)
        except Exception as e:
            traceback.print_exc()
