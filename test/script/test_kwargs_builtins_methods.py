...
class TestBuiltinsMethodsKeywordArgs(unittest.TestCase):
    ...
    def test_dict(self):
        ...
        # tx_ret = hvm.script(test_dict_update)()
    ...
    def test_str(self):
        ...
        tx_ret = hvm.script(test_str_split)()
        self.assertEqual(py_ret, tx_ret)
        ...
        tx_ret = hvm.script(test_any_split)()
        self.assertEqual(py_ret, tx_ret)
        ...
        tx_ret = hvm.script(test_str_encode)()
        self.assertEqual(py_ret, tx_ret)
        ...
        #
        # tx_ret = hvm.script(test_str_format)()
        # self.assertEqual(py_ret, tx_ret)
    ...
    def test_bytes(self):
        ...
        tx_ret = hvm.script(test_bytes_split)()
        self.assertEqual(py_ret, tx_ret)
        ...
        tx_ret = hvm.script(test_bytes_encode)()
        self.assertEqual(py_ret, tx_ret)
