...
class TestDynamicVarType(unittest.TestCase):
    ...
    def test_dynamic_generic_var_type(self):
        ...
        tx_ret = hvm.script(dynamic_generic_var_type)()
    ...
    def test_dynamic_loop_var_type(self):
        ...
        tx_ret = hvm.script(dynamic_loop_var_type)()
        self.assertEqual(py_ret, tx_ret)
    ...
    def test_dynamic_arg_type(self):
        ...
        tx_ret = hvm.script(dynamic_arg_type)(input_s)
        self.assertEqual(py_ret, tx_ret)
    ...
    def test_dynamic_var_type_across_scope(self):
        ...
        tx_ret = hvm.script(dynamic_var_across_if)(input_s)
        self.assertEqual(py_ret, tx_ret)
        ...
        tx_ret = hvm.script(dynamic_var_across_if2)(input_s)
        self.assertEqual(py_ret, tx_ret)
        ...
        tx_ret = hvm.script(dynamic_var_across_for_loop)()
        self.assertEqual(py_ret, tx_ret)
        ...
        tx_ret = hvm.script(dynamic_var_across_for_loop2)()
        self.assertEqual(py_ret, tx_ret)
        ...
        tx_ret = hvm.script(dynamic_var_across_while_loop)()
        self.assertEqual(py_ret, tx_ret)
        ...
        tx_ret = hvm.script(dynamic_var_across_try)()
        self.assertEqual(py_ret, tx_ret)
    ...
    def test_unexpected_dynamic_var_type(self):
        ...
        with self.assertRaises(Exception):
            hvm.script(unexpected_dynamic_var_across_if1)
        ...
        with self.assertRaises(Exception):
            hvm.script(unexpected_dynamic_var_across_if2)
        ...
        with self.assertRaises(Exception):
            hvm.script(unexpected_dynamic_var_across_if3)
        ...
        with self.assertRaises(Exception):
            hvm.script(unexpected_dynamic_var_across_loop1)
        ...
        with self.assertRaises(Exception):
            hvm.script(unexpected_dynamic_var_across_loop2)
        ...
        with self.assertRaises(Exception):
            hvm.script(unexpected_dynamic_var_across_loop3)
        ...
        with self.assertRaises(Exception):
            hvm.script(unexpected_dynamic_var_across_nested1)
        ...
        with self.assertRaises(Exception):
            hvm.script(unexpected_dynamic_var_across_nested2)
