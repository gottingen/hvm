...
class TestContainerDict(unittest.TestCase):
    ...
    def test_dict_notin(self):
        ...
        dict_notin_op = hvm.script(dict_notin)
    ...
    def test_dict_reserve(self):
        ...
        @hvm.script
        def dict_reserve(a: hvm.Dict, new_size: int) -> hvm.Dict:
            a.reserve(new_size)
            return a
    ...
    def test_dict_items(self):
        ...
        dict_items_op = hvm.script(dict_items)
    ...
    def test_general_items(self):
        ...
        general_items_op = hvm.script(general_items)
    ...
    def test_dict_keys(self):
        ...
        dict_keys_op = hvm.script(dict_keys)
    ...
    def test_general_keys(self):
        ...
        general_keys_op = hvm.script(general_keys)
    ...
    def test_dict_values(self):
        ...
        dict_values_op = hvm.script(dict_values)
    ...
    def test_general_values(self):
        ...
        general_values_op = hvm.script(general_values)
    ...
    def test_dict_get(self):
        ...
        dict_get_op = hvm.script(dict_get)
        d = {'known': 1}
        get_ret = dict_get(d)
    ...
    def test_general_dict(self):
        ...
        general_get_op = hvm.script(general_get)
        d = {'known': 1}
    ...
    def test_dict_pop(self):
        ...
        dict_pop_op = hvm.script(dict_pop)
        x, y = dict_pop()
        ...
        def dict_exception_pop() -> None:
            a = {'a': 1}
            a.pop('b')
        dict_exception_pop_op = hvm.script(dict_exception_pop)
    ...
    def test_generic_pop(self):
        ...
        generic_dict_pop_op = hvm.script(generic_dict_pop)
        ...
        def generic_dict_exception_pop() -> None:
            a = [{'a': 1}][0]
            a.pop('b')
        generic_dict_exception_pop_op = hvm.script(generic_dict_exception_pop)
