...
class TestFunction(unittest.TestCase):
    ...
    def test_call_with_more_types(self):
        ...
        def list_append_str(x: str) -> hvm.List:
            y = hvm.List([])
            y.append(x)
            return y

        @hvm.script
        def test_list_append() -> hvm.List:
            ss = "hello world"
            tt = list_append_str(ss)
            return tt

        self.assertEqual(test_list_append(), hvm.List(["hello world"]))
    ...
    def test_void(self):
        ...
        @hvm.script
        def list_mutation(a: hvm.List) -> None:
            a.append(1)
            a.append(2)
            a.append(3)
