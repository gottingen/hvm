...
class TestFormattedString(unittest.TestCase):
    ...
    def test_formatted_string_int(self):
        def hvm_formatted_string_single_int(i: int) -> str:
            return f"I got {i} !"

        a: int = 5
        result: str = hvm.script(hvm_formatted_string_single_int)(a)
        expect: str = "I got 5 !"
        self.assertEqual(result, expect)

    def test_formatted_string_multiple_int(self):
        def hvm_formatted_string_multiple_int(a: int, b: int, c: int) -> str:
            return f"I got {a} and {b} and {c} !"

        a: int = 5
        b: int = 9
        c: int = 100
        result: str = hvm.script(hvm_formatted_string_multiple_int)(a, b, c)
        expect: str = "I got 5 and 9 and 100 !"
        self.assertEqual(result, expect)

    def test_formatted_string_mixed_args(self):
        def hvm_formatted_string_mixed(a: int, b: float, c: str) -> str:
            return f"I got {a} and {b} and {c} !"

        a: int = 5
        b: float = 0.1
        c: str = "nothing "
        result: str = hvm.script(hvm_formatted_string_mixed)(a, b, c)
        expect: str = f"I got {a} and {b} and {c} !"
        self.assertEqual(result, expect)

    def test_formatted_string_with_op(self):
        def hvm_formatted_string_op(a: int, b: int, c: int) -> str:
            return f"{a}*{b} * {c} =  {a * b * c} !"

        a: int = 5
        b: int = 9
        c: int = 100
        result: str = hvm.script(hvm_formatted_string_op)(a, b, c)
    ...
    def test_formatted_string_customized_class_str(self):
        ...
        def hvm_formatted_string_with_customized_class(a: Any) -> str:
            return f"this obj has {a} !"

        a: myTest = hvm.script(myTest)(10)
        b: myTest = myTest(10)
        result: str = hvm.script(hvm_formatted_string_with_customized_class)(a)
    ...
    def test_formatted_string_mixed_with_class(self):
        ...
        def hvm_formatted_string_with_customized_class(a: myTest, s: str, i: int, f: float) -> str:
        ...
        f: float = 3.14
        b: myTest = myTest(10)
        result: str = hvm.script(hvm_formatted_string_with_customized_class)(a, s, i, f)
    ...
    def test_formatted_string_mixed_with_class_repr_any(self):
        ...
        def hvm_formatted_string_with_customized_class(a: Any, s: str, i: int, f: float) -> str:
            return f"I got string {s}, int {i}, float {f}, and a obj {a}"
    ...
    def test_formatted_string_mixed_with_func(self):
        ...
        def hvm_formatted_string_with_func(a: Any) -> str:
            return f"{a}"

        a: k = hvm.script(k)
        result: str = hvm.script(hvm_formatted_string_with_func)(a)
    ...
    def test_formatted_string_mixed_with_class_no_str(self):
        ...
        def hvm_formatted_string_with_customized_class(a: myTest) -> str:
            return f"{a}"
