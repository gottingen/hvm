...
class TestClassWithFullTypedVar(unittest.TestCase):
    ...
    def test_normal_class_full_typed_var(self):
        result = hvm.script(ClassWithFullTypedVar)().foo_sum()
        ...
        result = hvm.script(my_explicit_access_var)()
    ...
    def test_class_full_typed_var_generic_access(self):
        ...
        hvm.script(my_generic_access_var)()
        hvm.script(my_generic_set_var)()

        with self.assertRaises(Exception):
            hvm.script(my_explicit_set_var_as_other_var)

        hvm.script(my_explicit_set_var_constant)
