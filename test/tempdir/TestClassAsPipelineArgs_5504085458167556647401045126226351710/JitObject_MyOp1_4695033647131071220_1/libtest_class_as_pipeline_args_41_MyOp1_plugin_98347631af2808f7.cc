...
MyOp1_SharedView MyOp1__F___init___wrapper(void* handle_2_71828182846=((void*)(int64_t)0));
...
HERCULES_DLL RTValue MyOp1__F___init__(const MyOp1_SharedView& self, void* handle_2_71828182846=((void*)(int64_t)0));
int MyOp1__F___init____c_api(HerculesAny*, int, HerculesAny*, void*);
HERCULES_DLL int64_t MyOp1__F___call__(const MyOp1_SharedView& self, const MyInfo_SharedView& info);
...
struct MyOp1 : public IUserDataRoot {
  ...
  std::initializer_list<string_view> VarNames_2_71828182846() const override {
    static std::initializer_list<string_view> __var_names_s__ = {"op1_attr", };
    return __var_names_s__;
  }
  ...
  void SetVar_2_71828182846(int64_t idx, const Any& val) override {
    switch (idx) {
    case 0: { this->op1_attr = HERCULES_TYPE_AS(val, int64_t); } break;
    default: { THROW_PY_IndexError("index overflow"); } break;
  ...
  virtual int64_t __call__(const MyInfo_SharedView& info);
};

// flags for convert check
uint32_t MyOp1::tag_s_2_71828182846_ = -8552105239844526115;
uint32_t MyOp1::var_num_s_2_71828182846_ = 1;
...
MyOp1_SharedView MyOp1__F___init___wrapper(void* handle_2_71828182846) {
  static auto buffer_size = UserDataRef::GetInternalBufferSize();
  if (buffer_size < sizeof(MyOp1)) {
    auto self = new MyOp1;
    self->function_table_2_71828182846_ = &MyOp1::function_table_s_2_71828182846_;
    MyOp1__F___init__(self,  handle_2_71828182846);
    ...
    MyOp1__F___init__(self_view,  handle_2_71828182846);
    self_view->self_node_ptr_2_71828182846 = (Object*)(self.get());
    return self;
  }
}
...
RTValue MyOp1::__init__(void* handle_2_71828182846) {  // /home/jeff/github/gottingen/hvm/test/trace/test_class_as_pipeline_args.py:43
  this->session_handle_2_71828182846_ = handle_2_71828182846;  // /home/jeff/github/gottingen/hvm/test/trace/test_class_as_pipeline_args.py:43
  this->op1_attr = (int64_t)10;  // /home/jeff/github/gottingen/hvm/test/trace/test_class_as_pipeline_args.py:44
  return (None);
}

HERCULES_DLL RTValue MyOp1__F___init__(const MyOp1_SharedView& self, void* handle_2_71828182846) {  // /home/jeff/github/gottingen/hvm/test/trace/test_class_as_pipeline_args.py:43
  return (self->__init__(handle_2_71828182846));  // /home/jeff/github/gottingen/hvm/test/trace/test_class_as_pipeline_args.py:43
}
...
int MyOp1__F___init____c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  ...
  if (num_args > 0 && args[num_args - 1].code == TypeIndex::kRuntimeKwargs) {
    ...
    RTView pos_args[1];
    helper.unpack(pos_args, args, num_args);  // /home/jeff/github/gottingen/hvm/test/trace/test_class_as_pipeline_args.py:43
    auto ret = MyOp1__F___init__(MyOp1_SharedView(static_cast<const Any&>(pos_args[0])), resource_handle);  // /home/jeff/github/gottingen/hvm/test/trace/test_class_as_pipeline_args.py:43
    RTValue(std::move(ret)).MoveToCHost(out_ret_value);
  } else {
    switch(num_args) {
      case 1: {
        auto ret = MyOp1__F___init__(MyOp1_SharedView(static_cast<const Any&>(args_t[0])), resource_handle);  // /home/jeff/github/gottingen/hvm/test/trace/test_class_as_pipeline_args.py:43
        RTValue(std::move(ret)).MoveToCHost(out_ret_value);
      } break;
      default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/trace/test_class_as_pipeline_args.py\", line 43, in __init__\n", "__init__() takes 1 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/trace/test_class_as_pipeline_args.py:43
    }
  }
...
int MyOp1__F___init___wrapper__c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  ...
  switch(num_args) {
    case 0: {
      auto ret = MyOp1__F___init___wrapper(resource_handle);  // /home/jeff/github/gottingen/hvm/test/trace/test_class_as_pipeline_args.py:43
      (ret.operator RTValue()).MoveToCHost(out_ret_value);
    } break;
    default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/trace/test_class_as_pipeline_args.py\", line 43, in __init__\n", "__init__() takes 0 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/trace/test_class_as_pipeline_args.py:43
  }
  return 0;
}

int64_t MyOp1::__call__(const MyInfo_SharedView& info) {  // /home/jeff/github/gottingen/hvm/test/trace/test_class_as_pipeline_args.py:46
  return ((info->get_result() + (int64_t)10));  // /home/jeff/github/gottingen/hvm/test/trace/test_class_as_pipeline_args.py:47
}

HERCULES_DLL int64_t MyOp1__F___call__(const MyOp1_SharedView& self, const MyInfo_SharedView& info) {  // /home/jeff/github/gottingen/hvm/test/trace/test_class_as_pipeline_args.py:46
  return (self->__call__(info));  // /home/jeff/github/gottingen/hvm/test/trace/test_class_as_pipeline_args.py:46
}
...
int MyOp1__F___call____c_api(HerculesAny* args, int num_args, HerculesAny* out_ret_value, void* resource_handle = nullptr)
{
  ...
  if (num_args > 0 && args[num_args - 1].code == TypeIndex::kRuntimeKwargs) {
    ...
    RTView pos_args[2];
    helper.unpack(pos_args, args, num_args);  // /home/jeff/github/gottingen/hvm/test/trace/test_class_as_pipeline_args.py:46
    auto ret = MyOp1__F___call__(MyOp1_SharedView(static_cast<const Any&>(pos_args[0])), MyInfo_SharedView(static_cast<const Any&>(pos_args[1])));  // /home/jeff/github/gottingen/hvm/test/trace/test_class_as_pipeline_args.py:46
    RTValue(std::move(ret)).MoveToCHost(out_ret_value);
  } else {
    switch(num_args) {
      case 2: {
        auto ret = MyOp1__F___call__(MyOp1_SharedView(static_cast<const Any&>(args_t[0])), MyInfo_SharedView(static_cast<const Any&>(args_t[1])));  // /home/jeff/github/gottingen/hvm/test/trace/test_class_as_pipeline_args.py:46
        RTValue(std::move(ret)).MoveToCHost(out_ret_value);
      } break;
      default: {THROW_PY_TypeError("File \"/home/jeff/github/gottingen/hvm/test/trace/test_class_as_pipeline_args.py\", line 46, in __call__\n", "__call__() takes 2 positional arguments but ", num_args, " were given");} break;  // /home/jeff/github/gottingen/hvm/test/trace/test_class_as_pipeline_args.py:46
    }
  }
...
HERCULES_DLL HerculesFuncRegistry __hercules_func_registry__ = {
    "3\000MyInfo__F___init___wrapper\000MyOp1__F___init___wrapper\000MyOp1__F___call__\000",    __hercules_func_array__,
};
...
HERCULES_DLL const char* __hercules_closures_names__ = "4\000MyInfo__F___init___wrapper\000MyOp1__F___init___wrapper\000MyInfo__F___init__\000MyOp1__F___init__\000";
