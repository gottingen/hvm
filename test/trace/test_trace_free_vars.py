...
class TestTraceFreeVars(unittest.TestCase):
    ...
    def test_capture_prebuilt_op(self):
        ...
        compiled_op = hvm.script(my_capture_native_op)
        ...
        jit_mod_2 = hvm.load(save_path, "cpu")
    ...
    def test_capture_user_op(self):
        ...
        css = hvm.script(MyResource)()

        def my_capture_user_op() -> Any:
            return css()

        compiled_op = hvm.script(my_capture_user_op)
