...
def t():
    ...
    hvm.pmap(my_func, [1, 2, 3, 4])
    print("pmap_threads", hvm.pipeline.TXObject.default_sess.get_pmap_threads())
    print("async_threads", hvm.pipeline.TXObject.default_sess.get_apply_async_threads())
